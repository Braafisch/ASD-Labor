...
"""
Helper functions for traffic light visualization and GUI, cf. traffic light
simulator.
"""
...
class TrafficLightControlReceiver:
    """
    This class allows receiving the next phase of the traffic light via ros
